...
BEGIN_MESSAGE_MAP(CdocumentApp, CWinApp)
	ON_COMMAND(ID_APP_ABOUT, &CdocumentApp::OnAppAbout)
	// 基于文件的标准文档命令
...
CdocumentApp::CdocumentApp()
{
	...
	SetAppID(_T("document.AppID.NoVersion"));

	// TODO: 在此处添加构造代码，
	// 将所有重要的初始化放置在 InitInstance 中
}

// 唯一的一个 CdocumentApp 对象
